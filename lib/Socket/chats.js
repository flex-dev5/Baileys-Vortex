 ...
 * @param {string} jid The JID of the user in the call
 * @param {object} [reason] Optional reason for ending the call
 */
 ...
 * @param {string} jid The JID of the user to send offer to
 * @param {object} offer The offer details
 */
const sendCallOffer = async (callId, jid, offer) => {
    const from = authState.creds.me.id
 ...
 * Send call reject
 * @param {string} callId The ID of the call
 * @param {string} jid The JID of the user to reject call from
 ...
 * Send call accept
 * @param {string} callId The ID of the call
 * @param {string} jid The JID of the user to accept call from
 * @param {object} accept The accept details
 */
